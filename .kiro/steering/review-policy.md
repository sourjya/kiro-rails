...
When and how to trigger security and maintainability reviews. All reviews use prompts in `.kiro/prompts/`.
...
- Always check existing files in `docs/security/` and `docs/reviews/` to determine the next number
