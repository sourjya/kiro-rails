...
|---------|------|---------|
| v0.16.0 | 2026-07-08 | UX review tooling + interactive review guide - `ux-console-idiom.md` rubric (9 families, 44 checks, manual), `review-ux-live.md` browser-walk prompt, `ux-reviewer.json` agent, `style-survey.js` script, design tokens in overrides, `review-policy.md` UX triggers, `docs/ux-reviews/` taxonomy dir, `review-guide` skill, `review-suggest` hook, README "Getting Started with Reviews" section |
